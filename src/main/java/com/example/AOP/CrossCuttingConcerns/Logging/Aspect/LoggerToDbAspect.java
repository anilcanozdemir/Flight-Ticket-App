package com.example.AOP.CrossCuttingConcerns.Logging.Aspect;


import com.example.AOP.CrossCuttingConcerns.Logging.LogParameters;
import com.example.AOP.CrossCuttingConcerns.Logging.LogRepository;
import com.example.AOP.CrossCuttingConcerns.Logging.LogStatus;
...
public class LoggerToDbAspect {
    ...
    @Pointcut("@annotation(com.example.AOP.Annotations.Logging.LoggerToDbForResult)")
